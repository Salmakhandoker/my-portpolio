  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 border-t border-foreground/10" id="blog">
      <div className="text-center space-y-4">
        ...
        <div className="glass-card p-12 flex flex-col items-center justify-center space-y-4 border-dashed border-foreground/10">
          <div className="w-16 h-16 rounded-full bg-brand-card flex items-center justify-center text-foreground/50">
          ...
          <p className="text-foreground/50 font-bold uppercase tracking-widest text-xs">Articles and insights coming soon!</p>
        </div>
      </div>
    </section>
  );
